...
#-- 43bfea40ac8775b512acf633b698306d
#-- 5a7ca55e2a4b2ac5c61f4691bd641299
#-- 5d1e0ccc1411c472208d3dc458b99697
#-- 8ba98e66c2ce3e99cd1263a66744eebe
#-- 989f80a9eae740ba34589363054fd66b
#-- 9c2e65e471a83a104c2720d21da95ec3
#-- c9a7286d35670c9314e58cf42f931693

### Simple only collections
# Orange County manuscript maps
# metadata_dir = "/apps/content/dsc_mets/b703d23d8e465eb565c8cc0d8f5f23b1"
# Ly Kien Truc Photographs of the Hi-Tek Demonstrations
# metadata_dir = "/apps/content/dsc_mets/35d3af083b934a1f7821bdece2a1901c"
# Van Le files on Southeast Asian refugees
# metadata_dir = "/apps/content/dsc_mets/4841daa2799d21c51b4628cbf3540ac1"
# Collection on Refugee Forums
# metadata_dir = "/apps/content/dsc_mets/32c57480b9b6c487968daa919357eacc"
...
#
### Simple&Complex mixed collections
# Pleasants family papers
# metadata_dir = "/apps/content/dsc_mets/0bd519c78bf3089ad1ce8675b880bc4c"
# Mitsuye Yamada papers
# metadata_dir = "/apps/content/dsc_mets/69505f9e9148b0157ddb2d4b8ef2222e"
# Orange County Californio families portrait photograph album
# metadata_dir = "/apps/content/dsc_mets/a96f75066a453af9da03bf779dd01555"
# Orange County rancho title abstracts
# metadata_dir = "/apps/content/dsc_mets/510f6fd74506d996cdaa59be99b7f49f"
# Paul Tran files on Southeast Asian refugees
# metadata_dir = "/apps/content/dsc_mets/b4952b1f8e9082c5193c875fdc6c5865"
# Southeast Asia Resource Action Center records
# metadata_dir = "/apps/content/dsc_mets/59d4a10a3a0fbb611fc4c7e6722fb1c0"
# Mitchell I. Bonner photographs and ephemera
# metadata_dir = "/apps/content/dsc_mets/f85e4caca8b6bf4c2c3cb628ffcd444c"
# Guire Cleary collection of Hmong and Iu Mien domestic artifacts
# metadata_dir = "/apps/content/dsc_mets/fd4aa034c46fb02e7939572e0013931e"
# Brigitte Marshall collection on Southeast Asian refugees
# metadata_dir = "/apps/content/dsc_mets/989f80a9eae740ba34589363054fd66b"
# Gayle Morrison files on Southeast Asian refugees
# metadata_dir = "/apps/content/dsc_mets/84ce5a39da4b16c029e8efc98e8f3135"
# Project Ngoc records
# metadata_dir = "/apps/content/dsc_mets/cc8c5f09d92a39fb36ceeb5c86b03946"
# Southeast Asian Genetics Program records
# metadata_dir = "/apps/content/dsc_mets/671d241013cc5be9d5afee6797093ae9"
# Southeast Asian Archive vertical file collection
# metadata_dir = "/apps/content/dsc_mets/eec0fadb9e24423f3260fde0df1c3f12"
# Robert Walsh files on Southeast Asian refugee  resettlement and education
# metadata_dir = "/apps/content/dsc_mets/1a0bf93ac9ede5cb7072864e7afa07d7"
# Linda Vo collection on the Southeast Asian American Experience archive project
# metadata_dir = "/apps/content/dsc_mets/dfc0fbeb234aa6bd8073043346b26c19"
#
# No Collection Name
# Southeast Asian Archive monographs
metadata_dir = "/apps/content/dsc_mets/adeada4aafd3aff1bcc01b2db54db925"
