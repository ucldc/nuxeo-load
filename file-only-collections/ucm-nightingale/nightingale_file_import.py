...
def load_dir(content_dir):
    ...
    for component in components: 
        ...
        shortname = shorten_filename(component)
        ...
        copy_to = os.path.join(input_path, shortname)
...
def shorten_filename(filename):
    """ shorten filename to comply with Nuxeo 24-char limit """
    shortname = filename.replace('ucm_nightingale', 'ntgl')
    shortname = shortname.replace('nightingale', 'ntgl')
    return shortname
