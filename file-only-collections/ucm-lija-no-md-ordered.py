...
""" Batch load UCM LIJA-no-metadata sub-components with workaround so that they appear in Nuxeo in lexical order. """

content_dir = "/apps/content/new_path/UCM/LIJA-no-md/"
collection_name = "LIJA-no-metadata"
