...
def main(argv=None):
    ...
    _mkdir(temp_dir)
    pifolder_cmd = "pifolder --leaf_type SampleCustomPicture --input_path {} --target_path {} --folderish_type Organization".format(temp_dir, "/asset-library/UCR")
    print pifolder_cmd
    ...
    for subdir in subdirs:
        ...
        load_complex_dir(subdir_fullpath)
